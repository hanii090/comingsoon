    ...
    <footer className="border-t border-primary-purple/20 bg-background/80 backdrop-blur-lg">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Company */}
          <div className="space-y-4">
            <h3 className="text-text font-semibold">Company</h3>
            <ul className="space-y-2 text-sm text-textSecondary">
              <li><Link href="/about" className="hover:text-text transition-colors">About</Link></li>
        ...
        <div className="mt-12 pt-8 border-t border-primary-purple/20 flex flex-col sm:flex-row justify-between items-center">
          ...
          <div className="flex items-center space-x-4 mt-4 sm:mt-0">
            <Link href="https://twitter.com/foundify" className="text-textSecondary hover:text-text transition-colors">
              <span className="sr-only">Twitter</span>
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
                <path d="M6.29 18.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0020 3.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.073 4.073 0 01.8 7.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 010 16.407a11.616 11.616 0 006.29 1.84" />
              </svg>
            </Link>
            <Link href="https://github.com/foundify" className="text-textSecondary hover:text-text transition-colors">
